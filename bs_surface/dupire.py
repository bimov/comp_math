...
class DupireSolution:
    ...
    def get_values(self, tau: float, tol: float = 1e-10) -> np.ndarray:
        ...
        # Из-за особенностей округления ищем ближайшее значение в пределах tol
...
def _crank_nicolson_step(
    ...
    *,
    ...
    for idx in range(1, N - 1):
        S_i = S[idx]
        i = idx - 1  # индекс внутри трёхдиагональной системы
        coeff = sigma2 * (S_i ** 2)
